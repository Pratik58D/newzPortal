...
// slugify's own .d.ts doesn't resolve to a callable type under NodeNext
// (a quirk in that package's ambient module declaration) even though the
// default import works correctly at runtime - cast through unknown to
// bypass the broken static type only.
const slugify = slugifyImport;
